...
public class WXTabArticles {
    ...
    private int size;
    private int total;
    private List<WXTabArticle> datas;
    ...
    public List<WXTabArticle> getDatas() {
        return datas;
    }

    public void setDatas(List<WXTabArticle> datas) {
        this.datas = datas;
    }
}
